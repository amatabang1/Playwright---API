...
- Name: SBBankList.spec.ts >> Sandbox - Bank List API Test Suite >> TS-EB-SB-PRODUCTS-0089: Send Funds via Local Fund Transfer v1.0 _Get Supported Banks and Wallets API_Verify when Optional field "Transfer Network" (channel) is not provided to filter Financial Institutions
